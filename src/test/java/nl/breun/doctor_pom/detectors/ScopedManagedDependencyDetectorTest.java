...
class ScopedManagedDependencyDetectorTest {
    ...
    void should_report_an_issue_for_managed_dependencies_with_a_scope() {
        ProjectObjectModel projectObjectModel = TestUtils.projectObjectModelWithManagedDependencies(
                TestUtils.dependency("org.springframework", "spring-beans", "5.3.20", "compile"),
                TestUtils.dependency("junit", "junit", "4.13.2", "test")
        );
    ...
    void should_not_report_an_issue_for_managed_dependencies_without_a_scope() {
        ProjectObjectModel projectObjectModel = TestUtils.projectObjectModelWithManagedDependencies(
                TestUtils.dependency("org.springframework", "spring-core", "5.3.20", null),
                TestUtils.dependency("org.springframework", "spring-beans", "5.3.20", null)
        );
    ...
    void should_not_report_an_issue_for_a_managed_dependency_with_import_scope() {
        ProjectObjectModel projectObjectModel = TestUtils.projectObjectModelWithManagedDependencies(
                TestUtils.dependency("org.springframework.boot", "spring-boot-dependencies", "2.7.3", "import")
        );
